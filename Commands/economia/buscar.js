...
async execute (client, message, args) {
  ...
  if(mascotasperro <= 0 && mascotaspatos <= 0){
   message.reply("Se necesita una `Mascota` para poder usar este comando `Para comprarla use $shop transfiera el dinero que vale la Mascota que quiere a efectivo y despues use $buy (la mascota que quiere)`")
   return;
  }
