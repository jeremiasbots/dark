...
module.exports = {
    ...
    async aplication(interaction, client){
        ...
        const embedaceptar = new Discord.MessageEmbed()
          ...
          interaction.reply({ content: `La sugerencia ha sido rechazada`, ephemeral: true })

          const obteneracept = datasugs.canal

          usuario.send({ embeds: [new Discord.MessageEmbed().setTitle("Sugerencia rechazada").setDescription(`Tu sugerencia en **${interaction.guild.name}** ha sido rechazada | [ID DEL MENSAJE](https://discord.com/channels/${interaction.guildId}/${obteneracept}/${mensaje})`)] })
